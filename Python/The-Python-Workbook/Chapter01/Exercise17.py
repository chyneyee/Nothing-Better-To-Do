...
# The amount of energy required to increase the temperature of one gram of a material by one degree Celsius is the material’s specific heat capacity, C. 
# The total amount of energy required to raise m grams of a material by ΔT degrees Celsius can be
...
# Hint: The specific heat capacity of water is 4.186 * 4.2 J/g°C. 
# Because water has a density of 1.0 grams per mililiter, you can use grams and mililiters interchangeably in this exercise.
#
